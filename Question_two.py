...
def measure_inserts_in_begining_array():
    lst = list()
    for i in range(0,10):
        print("index " + str(i + 1) + " rotations: ")
        amount = 1500 * (2 ** (i + 1))
...
def measure_inserts_in_end_in_list():
    lst = list()
    for i in range(0,10):
        print("index " + str(i + 1) + " rotations: ")
        amount = 1500 * (2 ** (i + 1))
        start = time.time()
        index_to_insert = len(lst) - 1
        if index_to_insert == -1:
            index_to_insert = 0
        insert_to_list_n_times(lst, amount, index_to_insert)
        end = time.time()
...
def measure_inserts_in_random_in_arr():
    lst = list()
    for i in range(0,10):
        print("index " + str(i + 1) + " rotations: ")
        amount = 1500 * (2 ** (i + 1))
...
# measure_inserts_in_begining_array()
# measure_inserts_in_end_in_list()
measure_inserts_in_random_in_arr()